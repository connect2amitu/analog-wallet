...
const basicThemeColors = {
  primary: 'linear-gradient(89.78deg, #2406E2 0.19%, #7B35EE 99.81%)',
  secondary: 'linear-gradient(89.78deg, rgba(36, 6, 226, 0.1) 0.19%, rgba(123, 53, 238, 0.1) 99.81%)'
};
...
const darkTheme = {
  ...
  buttonBackgroundHover: 'linear-gradient(89.78deg, #2406E2 0.19%, #7B35EE 99.81%)',
