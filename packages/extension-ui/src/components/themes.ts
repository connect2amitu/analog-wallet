...
//   background: '#171717',
//   backgroundAccountAddress: 'linear-gradient(0deg, #201F20, #201F20), #171717;',
//   backgroundDropdownSeclection: 'rgba(0, 7, 45, .7)',
//   bodyColor: '#20222A',
//   borderRadius: '3px',
//   boxBorderColor: '#212845',
//   borderColor: '#EEEEEE',
//   borderColor2: 'rgb(32 31 32)',
//   boxMargin: '0.75rem 0',
//   boxPadding: '0 0.25rem',
//   boxShadow: 'rgba(0, 0, 0, 0.86)',
//   boxShadow2: '0px 0px 7px rgba(4, 193, 183, 0.4)',
//   buttonBackground: 'linear-gradient(95.49deg, #5D3EF8 -12.23%, #BA4CD6 117.24%);',
//   buttonBackground2: colors.primary2,
//   buttonBackgroundDanger: '#AF1111',
//   buttonBackground1: 'linear-gradient(95.49deg, #5D3EF8 -12.23%, #BA4CD6 117.24%);',
...
//   uploadFileBorderColor: 'rgb(32 31 32)',
...
//   overlayBackground: 'linear-gradient(95.49deg, #5D3EF8 -12.23%, #BA4CD6 117.24%);',
...
//   chainTextColor: '#E0894D',
//   chainBackgroundColor: 'rgba(224, 137, 77, 0.15)',
...
import analogLogoLight from '../assets/images/logo.png';
import analogLogoDark from '../assets/images/logo.png';
